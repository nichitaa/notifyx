defmodule Durian.ServiceStarter do
  use GenServer
  ...
  defp address(), do: DurianWeb.Endpoint.url()

  defp service_discovery_base_url!(),
    do: Application.fetch_env!(:durian, :service_discovery_base_url)

  defp register_url!(), do: service_discovery_base_url!() <> @register_endpoint
  defp service_name(), do: "auth"
end
